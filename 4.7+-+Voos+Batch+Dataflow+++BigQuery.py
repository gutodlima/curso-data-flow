...
pipeline_options = {
    ...
    'staging_location': 'gs://curso-apach-beam/temp',
    'temp_location': 'gs://curso-apach-beam/temp',
    'template_location': 'gs://curso-apach-beam/Template/batch_job_df_gcs_bigquery_voos',
    'save_main_session' : True }

pipeline_options = PipelineOptions.from_dictionary(pipeline_options)
p1 = beam.Pipeline(options=pipeline_options)

serviceAccount = r'C:\Users\gutod\OneDrive\Documentos\Curso Data-Flow\curso-dataflow-beam.json'
...
tabela = 'curso-dataflow-beam-386100.curso_dataflow_voos.curso_dataflow_voos_atraso'

Tempo_Atrasos = (
  p1
  | "Importar Dados Atraso" >> beam.io.ReadFromText(r"gs://curso-apach-beam/entrada/voos_sample.csv", skip_header_lines = 1)
...
Qtd_Atrasos = (
  p1
  | "Importar Dados" >> beam.io.ReadFromText(r"gs://curso-apach-beam/entrada/voos_sample.csv", skip_header_lines = 1)
...
tabela_atrasos = (
    ...
    | beam.io.WriteToBigQuery(
                              ...
                              custom_gcs_temp_location = 'gs://curso-apach-beam/temp' )
